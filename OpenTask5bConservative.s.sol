...
contract OpenTask5bConservative is Script {
    ...
    function run() external {
        ...
        // Start with conservative leverage (5x-6x) and larger collateral
        OpenParams[] memory positions = new OpenParams[](5);

        // Position 1: Long SpaceX at 5x with large collateral
        positions[0] = OpenParams(SPACEX_IPO, true, 1000_000000, 5e18);

        // Position 2: Long US-Iran at 6x
        positions[1] = OpenParams(US_IRAN, true, 800_000000, 6e18);

        // Position 3: Long FIFA Spain at 5x
        positions[2] = OpenParams(FIFA_SPAIN, true, 600_000000, 5e18);

        // Position 4: Short Fed Rate at 6x
        positions[3] = OpenParams(FED_RATE, false, 400_000000, 6e18);

        // Position 5: Long Argentina at 5x
        positions[4] = OpenParams(ARGENTINA, true, 300_000000, 5e18);
        ...
        console.log("");
        console.log("Total successful positions:", successCount, "/", positions.length);
