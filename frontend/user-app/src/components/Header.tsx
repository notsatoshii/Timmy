              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-sm text-gray-300">
                    <span className="font-medium text-purple">Read-only mode:</span> Browse markets, vault stats, and recent trades.
                    <span className="hidden sm:inline"> Connect wallet to trade.</span>
                  </p>
                </div>
                <div className="hidden sm:block">
                  <p className="text-xs text-gray-500">All data is live from Base Sepolia testnet</p>
                </div>
              </div>
            </div>
          </div>
